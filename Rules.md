...
2. Armored Ground Vehicles - Tanks and similar vehicles are allowed up to 450 HP and must use an LBA version (LBA, LBA Light) that makes sense for its respective type.
   - Faster, lightweight vehicles should have light armor, and heavily-armored vehicles should move more slowly.
   - As an example, a Jeep should not have full LBA, let alone more than 25 HP. 
